...
window.setPressurePage=page=>{pressurePage=page==='mantra'?'mantra':'tier';render()};window.resetOne=id=>{state=resetPlayer(state,id);save()};window.goMarket=()=>{view='market';render()};
