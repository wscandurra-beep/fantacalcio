import {CATEGORY_PRIORITY,rankPlayers,assignTiers,budgetSummary,slotPlanSummary,tierDepletion,updateForecasts,updateSlotStrategy,percentageOfBudget,formatPercentage,areaVariance} from './domain.js';
...
function slotTable(slots,editable=false){
  ...
  return `<div class="slot-table-wrap"><table class="slot-table"><thead><tr><th>Slot</th><th>Ruolo</th><th>Priorità</th><th>Baseline %</th><th>Baseline</th><th>Forecast</th><th>Forecast %</th><th>Actual</th></tr></thead><tbody>${body}</tbody>${totals}</table></div>`;
}
