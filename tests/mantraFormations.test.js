...
test('strategy dropdown derives options from centralized formations',async()=>{const source=await readFile(new URL('../src/app.js',import.meta.url),'utf8');assert.match(source,/getFormationIds\(\)\.map/);assert.doesNotMatch(source,/<option>3-4-2-1<\/option>/)});
